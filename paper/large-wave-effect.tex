...
phase (exactly so when their frequencies are rationally \emph{independent}, by Kronecker, and otherwise
as far as the relation lattice allows); on the infinite chain the spectrum is continuous, no exact
...
constant $\lim B_N/\sqrt N\in[0.6086,1]$ is open, and the segment constant $C=4/\pi^2$
...
(including the Talbot times $t=\pi a/N$) gives $\sup_N B_N/\sqrt N\approx0.88$--$0.96$; the optimal
constant in $[0.6086,1]$ is an almost-periodic / Gauss-sum supremum
