...
(Propositions~\ref{prop:breather},~\ref{prop:breather-stab}), while the precise dynamical self-trapping
threshold, the saturation/rogue dynamics, and the route to chaos are simulated, not proved. (vi)~The
...
(Proposition~\ref{prop:breather-stab}). What is open is the \emph{fully} nonlinear regime---saturation, the
precise dynamical launch threshold, and the rogue-wave focusing---where the admissible coupling shrinks
with the Diophantine alignment time.
