...
self-trapping threshold, with the exact constant $4$ (Proposition~\ref{prop:threshold}); the dispersal
(converse) side, the saturation/rogue dynamics, and the route to chaos are simulated, not proved. (vi)~The
...
\emph{fully} nonlinear regime---saturation, the dispersal (converse) side of the threshold, and the
