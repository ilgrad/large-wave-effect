...
$\limsup_N B_N/\sqrt N=\beta_{\mathrm{odd}}$: the sharp Gaussian-excess inequality
$\mathbb E|Z|-\mathbb E|G|\le K_\star\,\Sigma_2^{-3/2}\sum_\ell a_\ell^4$, $K_\star=(h(1)-\sqrt\pi/2)/2$
(extremizer the equal two-copy pair), whose integrated majorant clears $\beta_{\mathrm{odd}}$ on $(1,20]$;
proving it needs only a bound on the Bessel-ring tail of the Kluyver excess
