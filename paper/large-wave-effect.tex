...
criterion governs, and proposes a continuum model finer than the wave equation. \emph{It is therefore
possible that the qualitative ring effect and part of the composite analysis below are already
Filimonov's.} We have consulted only its abstract (the full note is not digitized in the sources available
to us);~\cite{F92} must be obtained and compared against Theorems~\ref{thm:prime}--\ref{thm:two}
and~\ref{thm:ceiling} before submission. The structural and quantitative claims below are accordingly
...
gradient-elasticity continualization~\cite{AAW,ASW12,ADK13}; our contribution is orthogonal, namely the
