...
evidence the constant has no limit; the whole $t>N/2$ reduction is now rigorous (joint equidistribution and
its uniform transfer to $F(s)$, Theorems~\ref{thm:joint-equi},~\ref{thm:uniform-transfer}), leaving one
validated sharp inequality (a Gaussian-excess/expected-modulus bound) before
