...
(Proposition~\ref{prop:dnls-mi}). What is open is the \emph{strongly} nonlinear regime past the linear
stage---saturation, existence and stability of discrete breathers, and the rogue-wave focusing---where the
admissible coupling shrinks with the Diophantine alignment time.
