...
(Section~\ref{sec:rogue}). The weakly nonlinear regime is settled---the linear large wave persists, with the
Duhamel bound of Proposition~\ref{prop:dnls-persist}---but the \emph{strongly} nonlinear regime (existence
and stability of discrete breathers, the role of the $\LN$ spectrum in the modulational-instability band,
the rogue-wave focusing) is open, the obstruction being that the admissible coupling there shrinks with the
