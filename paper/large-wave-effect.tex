...
(Proposition~\ref{prop:dnls-mi}); and breathers \emph{exist} on the ring by a finite-dimensional
variational argument (Proposition~\ref{prop:breather}). What is open is the \emph{strongly} nonlinear regime
past the linear stage---saturation, the \emph{stability} of those breathers, the precise dynamical launch
threshold, and the rogue-wave focusing---where the admissible coupling shrinks with the Diophantine
alignment time.
