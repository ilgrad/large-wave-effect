...
analytically on $87\%$ of the window (Jensen, sharpened by the tangent to the concave $h$) and reduced on
the rest to the monotonicity of $F$ on $[0.937,1]$---a one-dimensional statement free of $N$. The remaining residual is the rigorous upper
