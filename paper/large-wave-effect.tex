...
precision on primes of the same size), so $\Theta(\ln\ln\ln N)$ along primorials. What remains is a rigorous
matching \emph{lower} bound and the exact algebraic value per $N$ (certified per-$N$ brackets follow from the
