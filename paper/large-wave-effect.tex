...
asymptotics on the Dirichlet segment in~\cite{MF03} and the Schr\"odinger analogue in~\cite{F23}. The
lineage summarized in~\cite{F23} also includes early (1991--1992) work on the bead string---in particular
a multiple-frequency case bearing on the rational frequency dependencies studied here---which we have not
been able to consult directly; the structural claims below are stated as novel \emph{to our knowledge}.
...
limit unknown; and the segment constant $C=4/\pi^2$
