...
On the finite ring the \emph{existence} of these breathers needs no MacKay--Aubry continuation---it is a
...
$\Omega>0$ (above-band) condition. The \emph{stability} of these breathers (and the precise dynamical
launch threshold $\approx4$) is the rigorous sequel left open.
