...
With (i)--(iii), GSS yields orbital stability. Directly, \texttt{verify\_dnls\_breather\_stability.py} confirms
the linearisation spectrum is purely imaginary ($\max|\mathrm{Re}\,\lambda|\sim10^{-7}$) on the site-centred
branch over $\Omega\in[2,20]$, certifying (iii)'s no-crossing, versus a real pair
