...
see it. This is exactly where Morawetz/Strichartz arguments stall; \eqref{eq:virial} reduces the open
problem to a single estimate---a bound on the position-weighted nonlinear term in \eqref{eq:virial}, i.e.\
on the staggered momentum content $\langle\cos2k\rangle$.
