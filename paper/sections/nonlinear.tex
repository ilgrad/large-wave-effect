...
\noindent The converse direction---that for $\gamma P<4$ the single-site excitation actually disperses (as
it does numerically, e.g.\ $\max_j|u_j|^2\to0.007$ at $\gamma P=3$)---remains open; it is genuine
dispersive theory.
