...
The matching upper bound---that no other $t$ does better, i.e.\ that the $\sin^2$ dispersion admits no flat
(Gauss-sum) revival making $|K_N(\cdot,t)|$ uniform---is the one residual analytic question.
\end{remark}
