...
\tfrac2N\sum_{r=\frac12\varphi(2N)+1}^{\lfloor N/2\rfloor}\csc\tfrac{\pi r}N=\tfrac2\pi\ln\tfrac{N}{\varphi(2N)}+O(1)$.
...
value above), and at $t=N/2$ for odd $N$, where $|K_N(k,N/2)|=\sqrt{J_k(N)^2+J_{N-k}(N)^2}$ admits no
cancellation. The Debye envelope $|J_{Nu}(N)|\sim\sqrt{2/\pi N}\,(1-u^2)^{-1/4}|\cos\Phi|$ then yields the
exact value
...
For the upper side, the triangle inequality with Lemma~\ref{lem:bessel-l1} gives, for \emph{every} $t$,
$\|K_N(\cdot,t)\|_1\le\sum_{n}|J_n(2t)|=(1+o(1))c_0\sqrt{2t}$, hence with unitarity
\[
  \|K_N(\cdot,t)\|_1\ \le\ \min\!\bigl(c_0\sqrt{2t},\ \sqrt N\bigr),
\]
which for $t\le N/4$ is $\le c_0/\sqrt2\,\sqrt N$. So any time beating the even value $c_0/\sqrt2$ must lie in
