...
$A_N=U_N\Leftrightarrow N\text{ prime or }2^m$ for \emph{all} $N\le800$---extending the $N\le160$ of
Corollary~\ref{cor:density} by an order of magnitude (\texttt{exact/gap/scan\_classification.g}).
...
(Figure~\ref{fig:obstruction}; verified for $p\le13$, \texttt{exact/gap/prime\_square.g}). This explicit,
uniformly structured obstruction is a lead toward a constructive proof of the classification---which would
upgrade the saturation half of Corollary~\ref{cor:density} from a finite scan to a theorem---though we do
not prove it here.
\end{observation}
...
itself formalized, and the general classification remains open.
