...
B_N/\sqrt N=\beta_{\mathrm{odd}}$; the one residual is a rigorous upper bound on the multi-copy region
$t>N/2$, a quantitative no-revival estimate for the non-quadratic dispersion.
\end{remark}
