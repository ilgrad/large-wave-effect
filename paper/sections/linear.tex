...
(Gauss-sum) revival, even at structured Talbot times $t=\pi p/q$. So the global sup sits at $t=N/2$ and
$\limsup_N B_N/\sqrt N=\beta_{\mathrm{odd}}$; the one residual is a rigorous upper bound on the multi-copy
region $t>N/2$.
\end{remark}
