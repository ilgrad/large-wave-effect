...
consult beyond its abstract. It is therefore possible that the criterion---or the equivalent
characterization of when the ring saturates---is already, in whole or in part, in~\cite{F92}; this must be
checked against the primary source before any priority is claimed.
\end{remark}
