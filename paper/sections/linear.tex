...
$F(2t/N)$. The profile is maximized at $2t/N=1$---i.e.\ at $t=N/2$---with value $\beta_{\mathrm{odd}}$
(verified numerically, \texttt{verify\_bn\_parity.py}); granting that maximization,
