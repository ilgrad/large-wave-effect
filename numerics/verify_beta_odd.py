...
This is an elliptic-integral average; it has no apparent elementary closed form, but it is an exact
definite integral.  Numerically beta_odd = 0.92798...  This script checks that the integral matches the
direct large-N sum at t = N/2.
"""
...
def main() -> int:
    ...
    ok = abs(bi - direct[-1][1]) < 3e-3 and abs(bi - 0.92798) < 2e-3
    print("=" * 56)
